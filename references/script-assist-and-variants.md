...
| Fine or state-changing action | `remove` | Rewrite around stable product proof; use a named real insert only when the user explicitly requires it |
